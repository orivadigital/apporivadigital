...
const BACKUP_TABLES: BackupTable[] = [
  ...
  { name: "commercial_schedule_partners", order: "sort_order" },
  { name: "commercial_availability", order: "id" },
  { name: "commercial_schedule_blocks", order: "id" },
  { name: "commercial_meetings", order: "id" },
  { name: "commercial_meeting_participants", order: "meeting_id" },
