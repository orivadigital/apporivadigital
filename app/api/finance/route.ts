...
export async function GET(request: Request) {
  try {
    await requireAgencyAdministrator(request); const url = new URL(request.url); const month = url.searchParams.get("month") ?? ""; const delinquent = url.searchParams.get("delinquent") === "1";
